...
## ADR-063 — Healthcheck URL must include API version prefix; completeness_pct is a normalized float
...
## ADR-064 — Terraform hardening: RDS encryption+backups, S3 SSE+public-block, ECS Secrets Manager
